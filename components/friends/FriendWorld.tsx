  ...
  cemile: {
    ...
    diary: [
      ...
      },
      {
        date: '12 Mart 2026',
        title: 'O birkaç gün…',
        content: `Seninle ilgili son olarak 12 Mart 2026 tarihini yazmak istiyorum. O gün o kadar hastaydın ki, bize bunu hiç belli etmemeye çalışıyordun. Dışarıdan çok güçlü görünüyordun ve biz senin ne kadar hasta olduğunu gerçekten anlayamamıştık. Galiba iki tane serum yemesen, durumunun bu kadar ciddi olduğunu yine de fark edemezdik.\n\nO gün seni İstanbul'a götürürken de, gece uyuduğunda da, ertesi gün kan testi verirken de, Caddebostan'da bir kafede kediden korktuğunda da — kendimi sana adanmış bir halde buldum. Kan verirken etkilendiğini biliyordum ve seni o odadan en az etkilenmiş şekilde çıkarmak sanki benim bilinçsiz görevimdi. Aynı şekilde, Ravza'nın etrafında herhangi bir kedi olmaması gerektiğini de hep biliyormuşum gibi davranıyordum.\n\nBu yüzden o kafede de algılarım hep açıktı. Etrafta kedi arıyor, yaklaşmaması için bir şekilde onu uzaklaştırmaya çalışıyordum. Sen rahat edebilesin diye uğraşıyordum. Çünkü senin o an biraz bile rahatlaman benim için önemliydi.\n\nO akşam Deniz ablanın yaptığı magnolyayı yiyememen beni sandığımdan daha çok üzdü. Aslında o an tek istediğim şey senin bir an önce iyileşmen, kendine dönmen ve yine bildiğim Ravza olmandı. Ve ben o Ravza olman için elimden gelen her şeyi yapmaya çok hazırdım. Çünkü o güçlü, sağlıklı, mutlu ve huzurlu Ravza'yı çok seviyorum ve bazen o olamadığında bile ben tekrar o olabilmen için hayatım boyunca elimden gelen her şeyi yapacağım.\n\nHer zaman bir adım uzağındayım. O günden daha kötü bir gün geçirsen bile ben yine orada olurum. Seni yine o iğneden, o kediden korumaya çalışırım. Senin o magnolyayı sağlıklı ve güzel bir şekilde yiyebilmeni sağlarım.`,
      },
      {
        date: '1 Ocak 2025',
        title: "Saat 4.20'de…",
