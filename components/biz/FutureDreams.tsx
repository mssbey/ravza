...
const DREAMS: Dream[] = [
  ...
  { id:3, emoji:'🐴', title:'Atımız Olsun', body:'Ona da bir isim koyarız. Sabah gezintilerinde ikimiz de süreriz, hangimiz daha iyi sürer onu tartışırız.', color:'#e08000', glowRgb:'224,128,0', locked:false, gradient:'linear-gradient(135deg, rgba(224,128,0,.12) 0%, rgba(150,70,0,.06) 100%)' },
  { id:4, emoji:'🌍', title:'Makedonya', body:"Akrabalarını ziyaret eder, yöreyi birlikte gezeriz. Senin memleketin benim de mekânım olur.", color:'#FF4D88', glowRgb:'255,77,136', locked:false, gradient:'linear-gradient(135deg, rgba(255,77,136,.12) 0%, rgba(180,0,70,.06) 100%)' },
