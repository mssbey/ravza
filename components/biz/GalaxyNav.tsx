...
const PLANETS: Planet[] = [
  ...
  {
    id: 'sevgili',
    title: 'Sevgili Olduğumuz Gün',
    sub: 'En özel günümüz',
    emoji: '💖',
    size: 106,
    gradient: 'radial-gradient(circle at 34% 28%, #ffb6ce, #ff4d88 30%, #c01855 60%, #460820 88%)',
    glow: '#ff4d88', glowRgb: '255,77,136',
    desktopPos: { x: '58%', y: '55%' },
  },
  {
    id: 'album',
    title: 'Albümümüz',
  ...
  },
  {
    id: 'harita',
    title: 'Aşk Haritası',
    sub: 'Birlikte keşfettiklerimiz',
    emoji: '📍',
    size: 62,
    gradient: 'radial-gradient(circle at 34% 28%, #a0fff8, #00c8a8 30%, #007a6a 60%, #001f1c 88%)',
    glow: '#00c8a8', glowRgb: '0,200,168',
  ...
  },
  {
    ...
    sub: 'Keşfetmeye hazır mısın?',
    emoji: '⭐',
    size: 54,
    gradient: 'radial-gradient(circle at 34% 28%, #aaaaf8, #5555cc 30%, #1a1a88 60%, #040414 88%)',
    glow: '#7777ff', glowRgb: '120,120,255',
    desktopPos: { x: '88%', y: '50%' },
  },
]
